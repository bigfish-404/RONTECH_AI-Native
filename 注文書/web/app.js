...
const elements = Object.fromEntries([
  ...
  "selectOutputButton", "outputRootLabel", "targetMonth", "companyCount", "projectCount", "engineerCount",
  "selectAll", "displayCount", "companyList", "emptyState", "clearSelectionButton", "collapseAllButton", "expandAllButton",
...
async function loadData(confirmDiscard = false) {
  ...
  try {
    ...
    if (!state.outputRoot) state.outputRoot = text(data.outputRoot);
